      ...
      <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl p-8 w-full max-w-md border border-white/20">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-sm">
              <a href="#" className="text-blue-500 hover:text-purple-600 transition-colors">
                Forgot password?
              </a>
            </div>
          </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-gray-600">
            ...
            <Link to="/register" className="text-blue-500 hover:text-purple-600 font-medium transition-colors">
              Sign up here
            </Link>
          </p>
        </div>
